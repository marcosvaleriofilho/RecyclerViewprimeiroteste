...
class TarefasAdapter (private val dataSet: List<Tarefa>):
    ...
    /* ViewHolder para a Tarefa, define as referencias das views e acrecenta o "click". */
    ...
    // Cria a viewHolder(view temporária para armazenar o item e "infla" com o layout apropriado.
